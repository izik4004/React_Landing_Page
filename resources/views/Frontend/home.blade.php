         ...
         <ul class="nav nav-sidebar-menu sidebar-toggle-view">
             <li class="nav-item sidebar-nav-item">
                 ...
                 <ul class="nav sub-group-menu">
                     ...
                     <li class="nav-item">
                         <a href="index4.html" class="nav-link"><i class="fas fa-angle-right"></i>Teachers</a>
                     </li>
                     <!-- <li class="nav-item">
             ...
             <li class="nav-item sidebar-nav-item">
                 ...
                 <ul class="nav sub-group-menu">
                     <li class="nav-item">
                      ...
                      <li class="nav-item">
                         <a href="add-teacher.html" class="nav-link"><i class="fas fa-angle-right"></i>
                             Teacher Form</a>
                     </li>
                     <!-- <li class="nav-item">
                         <a href="teacher-details.html" class="nav-link"><i
                                 class="fas fa-angle-right"></i>Registration</a>
                     </li> -->
                     <!-- <li class="nav-item">
                 ...
                 <ul class="nav sub-group-menu">
                     ...
                     <li class="nav-item">
                         <a href="admit-form.html" class="nav-link"><i
                                 class="fas fa-angle-right"></i>Student Form</a>
                     </li>
                     <!-- <li class="nav-item">
