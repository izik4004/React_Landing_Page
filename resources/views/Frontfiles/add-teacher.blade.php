                    ...
                    <ul class="nav nav-sidebar-menu sidebar-toggle-view">
                        ...
                        <li class="nav-item sidebar-nav-item">
                            ...
                            <ul class="nav sub-group-menu">
                                ...
                                <li class="nav-item">
                                    <a href="add-parents.html" class="nav-link"><i class="fas fa-angle-right"></i>Registration
                                    Form </a>
                                </li>
                            </ul>
                        </li>
            ...
            <div class="dashboard-content-one">
                ...
                <div class="card height-auto">
                    <div class="card-body">
                        ...
                        <form class="new-added-form" method="POST" action="{{ route('teachers.store') }}">
                            @csrf
                            <div class="row">
                                ...
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    ...
                                    <input type="date" placeholder="dd/mm/yyyy" class="form-control air-datepicker" name="date_of_birth" required>
                                    <i class="far fa-calendar-alt"></i>
                                </div>
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    <label>ID No</label>
                                    <input type="text" placeholder="" class="form-control" name="id_no">
                                </div>
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                ...
                                <div class="col-lg-6 col-12 form-group">
                                    ...
                                    <textarea class="textarea form-control" id="form-message" cols="10" rows="9" name="bio"></textarea>
                                </div>
